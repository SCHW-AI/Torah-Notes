...
However, a דבר הראוי להתכבד that is not intrinsically אסור but just absorbed איסור can become בטל, because it's not really the דבר הראוי להתכבד that needs to be nullified, it's just the בליעות of איסור it contains that need to be nullified.
