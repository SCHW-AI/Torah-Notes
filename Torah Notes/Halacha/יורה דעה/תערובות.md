...
The ש"ך (שם ס"ק ג) forcefully rejects the explanation of the ט"ז, because if the utensil is clean, what transfer of residue or flavor is there for הדחה to remove? Additionally, the שך is baffled  the רמא's distinction if the utensil absorbed flavor through a heat-based transfer or a cold-based transfer