...
#### Residue:
When solid היתר comes into contact with solid איסור, so long as one of the items is moist, in order to consume the היתר one must first [[Measurements#Surface Level|rinse]] the point where the היתר touched the איסור, because we assume that the איסור left residue on the היתר (see שו"ע יו"ד צא:א).
