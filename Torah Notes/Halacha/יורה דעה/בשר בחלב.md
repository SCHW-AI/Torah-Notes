...
##### Liquids:
Liquids (other than בב"ח) that mix together do not become חענ"נ^[רמ"א צב:ד]. There are two possible reasons for this:

+  Liquid, on the other hand, is viewed as a collection of drops rather than a cohesive unit, and so the fact that some of the drops are prohibited is no reason to consider the other drops prohibited.
+  Liquid, which is a collection of discrete drops rather than a cohesive whole, can become permitted by mixing it in to a larger body of permitted liquid, because at that point there's no distinction with the permitted component of the original mixture and the permitted liquid it was mixed in to.
