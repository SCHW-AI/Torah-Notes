...
For example, if one cooks a pot of meat, and he accidentally left in a piece of חֵלב, which is less than 1/60 of the total volume of the contents of the pot: if the חלב was not touching any particular

חלב cannot effect חענ"נ in a piece of kosher meat it is cooked with (assuming the rest of the mixture has the requisite volume to nullify the חלב) unless
