...
+ the מרדכי^[הובא בט"ז שם ס"ק טו] holds that the רבנן only extended חענ"נ to solid foods, not liquids, because solid foods are distinct; in other words, the רבנן were only concerned that permitting a solid by nullifying just the איסור it contains could lead to confusion in a similar case of בב"ח
+ 
