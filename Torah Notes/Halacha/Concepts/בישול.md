...
## תתאה גבר:
When something hot comes into contact with something cold, whether the hot item heats the cold item or the cold item cools the hot item — the consequence being whether the items cook together and thereby transfer flavors to each other — is debated in the Gemara (source). We Pasken that whichever item is lower (although according to many this is actually interpreted to mean the stationary item) extends its state to the upper (moving) item (תתאה גבר), so if the lower (stationary) item is hot, it makes the upper (moving) item hot as well, and flavor transfers throughout both. If, however, the upper (moving) item is hot and the lower (stationary) item is cold, the lower cools the upper and the two items just need [[מדות#כדי קליפה|קליפה]]^[The reason [[מדות#Surface Level|הדחה]] is not enough, even though they're both cold, is that the cooling is not instant and in the time it takes for the upper item to cool the flavor can transfer כדי קליפה (see ש"ך יו"ד ס' צא ס"ק  ז).]^[see שו"ע יו"ד צא:ד]. ^ba819c
